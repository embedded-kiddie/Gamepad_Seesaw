...
#define NUNCHUCK_SDA 27 //D27 // or 22 (SCL)
#define NUNCHUCK_SCL 22 //SCL // or 27 (D27)
...
void setup() {
  ...
  if (!ss.begin(SEESAW_GAMEPAD_ADDRESS, NUNCHUCK_SDA, NUNCHUCK_SCL, 400000)) {
